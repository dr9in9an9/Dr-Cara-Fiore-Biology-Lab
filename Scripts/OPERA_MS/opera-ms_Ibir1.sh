#!/bin/bash
#SBATCH --job-name=opera_ms_Ibir1
#SBATCH --output=opera_ms_Ibir1.%j.out
#SBATCH --error=opera_ms_Ibir1.%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p results/OPERA-MS/Ibir1

# Run OPERA-MS
perl /hpc/modules/apps/OPERA-MS/OPERA-MS.pl \
    --short-read1 01_raw_fastq/Ibir1_R1_001.fastq.gz \
    --short-read2 01_raw_fastq/Ibir1_R2_001.fastq.gz \
    --long-read 01_raw_fastq/Ibir_longreads.fastq \
    --out-dir results/OPERA-MS/Ibir1 \
    --num-processors 8 \
