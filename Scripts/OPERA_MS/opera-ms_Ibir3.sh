#!/bin/bash
#SBATCH --job-name=opera_ms_Ibir3
#SBATCH --output=opera_ms_Ibir3.%j.out
#SBATCH --error=opera_ms_Ibir3.%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p results/OPERA-MS/Ibir3

# Run OPERA-MS
perl /hpc/modules/apps/OPERA-MS/OPERA-MS.pl \
    --short-read1 01_raw_fastq/Ibir3_R1_001.fastq.gz \
    --short-read2 01_raw_fastq/Ibir3_R2_001.fastq.gz \
    --long-read 01_raw_fastq/Ibir_longreads.fastq \
    --out-dir results/OPERA-MS/Ibir3 \
    --num-processors 8 \
